...
public class OddEvenHelperTest {
    ...
    @Test
    void fixBug(){
        assertEquals(true, OddEvenHelper.isEven(-8));
        assertEquals(false, OddEvenHelper.isOdd(-8));
        assertEquals(true, OddEvenHelper.isOdd(-7));
        assertEquals(false, OddEvenHelper.isEven(-7));
    }
